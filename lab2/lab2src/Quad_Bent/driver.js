...
function start(gl) {
    ...
    var arr = [0.08660254037844388, 0.4, 0.049999999999999996,
     0.08660254037844388, 0, 0.049999999999999996,
     0.05000000000000002, 0, 0.08660254037844387,
     0.05000000000000002, 0.4, 0.08660254037844387]

     drawSquare(arr, gl)

    // set the vertices of the quad
    //var vertices = new Float32Array([0.2, 0.1, 0,    // top right
